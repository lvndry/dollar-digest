...
export function FilterBar({ filterOptions, currentFilter }: FilterBarProps) {
    ...
    <div ref={containerRef} className="mb-10">
      ...
      >
        <span
          ...
          style={{
            color: currentFilter ? "var(--accent)" : "var(--ink-muted)",
            transition: "color 0.2s ease",
          }}
        >
          {currentFilter ? `Filter by · ${currentFilter}` : "Filter by"}
        </span>
        <span
